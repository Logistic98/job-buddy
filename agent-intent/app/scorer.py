...
_INTENT_KEYWORDS: list[dict] = [
    {
        ...
        "keywords": {
            "offer": 3, "跳槽": 3, "薪资": 2, "待遇": 2, "谈薪": 3, "裁员": 2,
            "试用期": 2, "入职": 2, "离职": 2, "晋升": 2, "职业规划": 3, "行情": 2,
        },
    },
    {
        "domain": "runtime",
        ...
        "keywords": {
            "脚本": 2, "部署": 2, "调试": 2, "报错": 2, "异常": 2, "性能": 2,
            "架构": 2, "数据库": 2, "接口": 2, "bug": 3, "sql": 2, "api": 2,
        },
    },
    {
        "domain": "security",
