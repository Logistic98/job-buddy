...
def _base_run(extra_trace=None):
    ...
    return {
        ...
        "trace_events": trace,
        "tool_events": [{"status": "success", "tool": "sample_tool"}],
    }
        ...
        [
            {
                ...
                "payload": {
                    "success": True,
                    "duration_ms": 12,
                    "results": [{"tool": "sample_tool", "success": True, "duration_ms": 12}],
                },
            },
        ]
    )
        ...
        [
            {
                ...
                "payload": {"tool": "broken_tool", "error": "上游超时", "duration_ms": 30, "permission_denied": False},
            },
        ]
    )
    bad_run = _base_run(
...
def test_llm_usage_payload_requires_calls_and_tokens():
    ok_run = _base_run(
        [
            {
                "event": "llm_usage",
                "payload": {"llm_calls": 2, "prompt_tokens": 100, "completion_tokens": 40, "total_tokens": 140},
            },
        ]
    )
    bad_run = _base_run(
