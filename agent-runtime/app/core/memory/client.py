...
class MemoryClient:
    ...
    def search(self, query: str, scope: Optional[str] = None, trace_id: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        try:
            response = httpx.get(url, params=params, timeout=config.timeout_seconds)
