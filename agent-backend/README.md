...
`agent-backend` 是 JobBuddy 的 Java 17 + Spring Boot 3 业务后端和 API 入口，负责认证授权、业务事务、关系数据、对象文件、会话持久化及下游编排。Boss 工具的具体实现位于 agent-tool，Backend 的业务请求经 Runtime 工具代理统一治理。
