...
public class RbacAdminController {
   ...
   *
   * @param service 服务
   * @param permissionDelegationService 权限委派服务
   */
   ...
   * @param body 请求体
   * @param request 请求对象
   * @return 更新后的租户角色的基础信息，并在提供菜单列表时同步更新授权
   */
