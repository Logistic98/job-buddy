...
/**
 * Runtime 托管请求工厂：统一构造流式/非流式托管请求体与元数据，并装配个人上下文，
 * 保证消息/预算/元数据在各调用入口保持一致。
 */
class RuntimeManagedRequestFactory {
    ...
    RuntimeManagedRequestFactory(AgentIntegrationService integrationService,
    ...
    Map<String, Object> buildPersonalContext(String message, IntentResult intent, ChatSessionState state) {
        try {
    ...
    Map<String, Object> runRuntimeManagedAnswerWithProfile(String sessionId, String message, String profile, Map<String, Object> extraMetadata) {
    ...
    Map<String, Object> buildRuntimeManagedRequest(String sessionId, String message, String profile, Map<String, Object> extraMetadata, boolean stream) {
    ...
    Map<String, Object> runtimeManagedMetadata(String message, ChatSessionState state, Map<String, Object> directive, IntentResult intent) {
        Map<String, Object> metadata = new LinkedHashMap<String, Object>();
